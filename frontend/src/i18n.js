...
const messages = {
  "en-US": {
    ...
    brand: {
      name: "Solo Founder Agent",
      subtitle: "17-Role AI Collaboration OS · v1.8.0",
    },
    status: {
      ready: "System Ready",
    },
    ...
    overview: {
      chip: "Solo Founder Architecture v1.8.0 · Live Demo",
      headline1: "Hire 17 AI roles.",
      headline2: "Watch the company run itself.",
      desc: "You + 17 AI roles = a company that actually runs. CKO triages, roles relay, 4 quality gates enforce, 5-path distillation closes the loop. Based on Solo Founder Architecture v1.8.0.",
      flowTitle: "Three Steps",
      flowDesc: "Follow this order to ship your first project in 3 minutes.",
      step1Title: "Hire Roles",
      step1Desc: "17 roles with §0 mentor benchmarks (Jobs / Linus / Deming / Karpathy). Ready out of the box.",
      step2Title: "Pick Pattern",
      step2Desc: "6 patterns including [Solo Founder Flow]: CKO triage → role relay → 5-path writeback.",
      step3Title: "Run Project",
      step3Desc: "One sentence in. Watch nodes light up. Live trace. Export the distillation card.",
      agents: "Roles",
      workflows: "Setups",
      templates: "Patterns",
    },
  ...
  "zh-CN": {
    ...
    brand: {
      name: "一人公司 Agent",
      subtitle: "17 岗位 AI 协作 OS · v1.8.0",
    },
    status: {
      ready: "系统就绪",
    },
    ...
    overview: {
      chip: "一人公司架构 v1.8.0 · Live Demo",
      headline1: "招齐 17 个岗位。",
      headline2: "让公司自己跑起来。",
      desc: "你 1 个 + 17 个 AI 岗位 = 一家会运转的公司。CKO 自动分诊 → 岗位接力执行 → 4 道质量闸 → 五路径回写。基于一人公司架构 v1.8.0。",
      flowTitle: "上手三步",
      flowDesc: "按下面顺序体验,3 分钟跑通第一个项目。",
      step1Title: "招岗位",
      step1Desc: "17 岗位带 §0 对标人物(Jobs / Linus / Deming / Karpathy),开箱即用。",
      step2Title: "选协作流程",
      step2Desc: "6 种模式可选 · 含独家「一人公司协作流」:CKO 分诊 → 岗位接力 → 五路径回写。",
      step3Title: "跑项目",
      step3Desc: "一句话发起 · 看节点逐个亮 · trace 实时追踪 · 导出蒸馏卡。",
      agents: "岗位",
      workflows: "协作流",
      templates: "协作模式",
    },
